			...
			<div className="container container--xxl group-vt gap--xxl hz--center talign--center">
				<div className="group-vt gap--lg hz--center">
						...
						<g>
							<g>
								...
								<g
									id="right-eye"
									style={{
										transformOrigin: "106.885px 76.169px",
									}}
								>
					...
					<div className="group-vt gap--xs max-width--xs text-balance">
						<p>
							We’ve received your details and your cards will be
							on their way shortly.
						</p>
						<p>
							You’ll get a <strong>confirmation email</strong> in
							a moment with everything you need.
						</p>
					</div>
				</div>
