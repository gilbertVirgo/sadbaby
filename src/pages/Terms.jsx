		...
		<div className="wrapper">
			<div className="terms__container container container--xxl group-vt gap--lg max-width--sm">
				...
				<section className="group-vt gap--xxs">
					<h2>1. About Us</h2>
					<p>
						We are a small business creating and selling handmade
						cards. Customers can purchase:
					</p>
					<ul>
						<li>
						...
						<li>
							<strong>Packs of cards</strong> — delivered to the
					...
					<p>
						...
						recipient, you are responsible for providing the correct
						message, spelling, and recipient address. We copy your
						message exactly as provided and cannot make corrections
						unless you notify us before the order is processed.
					</p>

					<h3>Card Packs</h3>
					<p>
						Packs will be sent to the delivery address you enter at
						checkout. Please ensure all details are correct before
						completing your order.
					</p>

					<p>
						We reserve the right to decline or cancel any order (for
						example, if we believe the order contains offensive or
						harmful content).
					</p>
					...
					<p>
						...
						update prices at any time, but this will not affect
					...
					<p>
						...
						provided by Royal Mail and are not guaranteed. Once an
						order has been posted, delivery is outside our control.
					</p>

					<h3>Lost or Delayed Items</h3>
					<p>
						If your order does not arrive within the expected
						timeframe, please contact us. We will assist where we
						can, but we cannot accept liability for delays caused by
						Royal Mail. If an item appears to be lost, we may offer
					...
					<p>
						...
						<strong>before</strong> it has been written or posted.
					</p>

					<p>
						Once a personalised card has been completed or posted,
						it cannot be cancelled or returned.
					</p>

					<p>
						Card packs (non-personalised) may be cancelled before
						dispatch. If already dispatched, they may be returned
						unused and in their original condition within 14 days of
						delivery; return postage is the customer’s
						responsibility.
					</p>
					...
					<p>
						...
						cards cannot be returned unless the product is faulty or
					...
					<p>
						All content on the site — including images, text, and
						designs — is our property and must not be copied or
					...
					<p>
						...
						it. We do not share your details with third parties
						except for necessary delivery and payment services. For
					...
					<ul>
						<li>
							Delays, losses, or damages caused by Royal Mail or
						...
						<li>
							Any indirect or consequential loss that arises from
